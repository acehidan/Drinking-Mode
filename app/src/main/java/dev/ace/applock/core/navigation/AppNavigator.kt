...
import dev.ace.applock.features.appintro.ui.AppIntroScreen
import dev.ace.applock.features.applist.ui.MainScreen
import dev.ace.applock.features.home.ui.HomeScreen
import dev.ace.applock.features.lockscreen.ui.PasswordOverlayScreen
import dev.ace.applock.features.setpassword.ui.SetPasswordScreen
import dev.ace.applock.features.settings.ui.ContactSupportScreen
import dev.ace.applock.features.settings.ui.LanguageScreen
import dev.ace.applock.features.settings.ui.SettingsScreen
import dev.ace.applock.features.settings.ui.TestDifficultyScreen
import dev.ace.applock.features.triggerexclusions.ui.TriggerExclusionsScreen
...
fun AppNavHost(navController: NavHostController, startDestination: String) {
    ...
    NavHost(
        ...
        composable(Screen.TestDifficulty.route) {
            TestDifficultyScreen(navController)
        }
    }
}
        ...
        val biometricPrompt = BiometricPrompt(
            ...
            object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationFailed() {
                    ...
                    Log.w(TAG, "Bi-metric authentication failed (not recognized)")
                }
            }
        )

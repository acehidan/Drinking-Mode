package dev.ace.applock.core.broadcast
...
import dev.ace.applock.services.AppLockAccessibilityService
...
class BootReceiver : BroadcastReceiver() {
    ...
    private fun startAppropriateServices(
        context: Context,
        repository: dev.ace.applock.data.repository.AppLockRepository
    ) {

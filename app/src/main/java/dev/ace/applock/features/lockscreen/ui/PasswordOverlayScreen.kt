...
import dev.ace.applock.core.ui.shapes
import dev.ace.applock.core.utils.appLockRepository
import dev.ace.applock.core.utils.vibrate
import dev.ace.applock.data.model.LockType
import dev.ace.applock.data.repository.AppLockRepository
import dev.ace.applock.services.AppLockManager
import dev.ace.applock.ui.icons.Backspace
import dev.ace.applock.ui.icons.Fingerprint
...
class PasswordOverlayActivity : FragmentActivity() {
    ...
    private val typingGameViewModel: TypingGameViewModel by viewModels {
        TypingGameViewModelFactory((application as AppLockApplication).preferencesRepository)
    }

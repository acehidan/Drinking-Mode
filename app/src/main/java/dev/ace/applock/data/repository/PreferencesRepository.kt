package dev.ace.applock.data.repository
...
class PreferencesRepository(context: Context) {
    ...
    fun setLanguage(language: String) {
        settingsPrefs.edit { putString(KEY_LANGUAGE, language) }
    }

    fun getLanguage(): String {
        return settingsPrefs.getString(KEY_LANGUAGE, "English") ?: "English"
    }

    // Game Settings
    fun setGameDifficulty(difficulty: Difficulty) {
        settingsPrefs.edit { putString(KEY_GAME_DIFFICULTY, difficulty.name) }
    }

    fun getGameDifficulty(): Difficulty {
        val difficultyName = settingsPrefs.getString(KEY_GAME_DIFFICULTY, Difficulty.Medium.name)
        return try {
    ...
    companion object {
        ...
        private const val KEY_GAME_DIFFICULTY = "game_difficulty"
